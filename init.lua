-- :help lua-guide for seeing how Neovim integrates lua.
-- <leader>sh opens a Telescope window to search through the documentation.
...
-- Set 'netrw' to also use relative numbering.
...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        --
        -- For info, please read `:help ins-completion`, it is really good!
        --
  ...
  -- Colorthemes installed:
  -- Find more colorthemes on: https://vimcolorschemes.com/i/trending
  {
  ...
  { dir = vim.fn.stdpath 'config' .. '/lua/custom/plugins/flatbuffers.nvim' },
